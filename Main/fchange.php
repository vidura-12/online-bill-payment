...
$sql = "UPDATE financial_menager SET firstname = ?, lastname = ?, email = ?, address = ?, username = ? WHERE username = ?";
...
if ($stmt->execute()) {
    ...
    window.location.href = 'financial_profile.php';
    </script>";
} 
...
if(isset($_POST['back']))
{
    header("Location: financial_profile.php");
}
...
<body>
<div id="addimg">
<form method="post" action="fchange.php" class="editprofile">
